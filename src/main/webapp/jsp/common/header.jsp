...
<div class="navigation-bar dark">
    <div class="navigation-bar-content container">
        <a href="/" class="element"><span class="icon-grid-view"></span> Honor do it <sup>2.0</sup></a>
        <span class="element-divider"></span>

        <a class="element1 pull-menu" href="#"></a>
        <ul class="element-menu">
            <li>
                <a class="dropdown-toggle" href="#">用户信息</a>
                <ul class="dropdown-menu dark" data-role="dropdown">
                    <li><a href="javascript:;" onclick="userManager()">用户管理</a></li>
                    <li>
                        <a href="#" class="dropdown-toggle">我的世界</a>
                        <ul class="dropdown-menu dark" data-role="dropdown">
                            <li><a href="global.html">我的足迹</a></li>
                            <li><a href="grid.html">我的备注</a></li>
                        </ul>
                    </li>
                    <li class="divider"></li>

...
<link href="${BasePath}/ui/css/iconFont.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="${BasePath}/ui/js/prettify/prettify.js"></script>
<script type="text/javascript" src="${BasePath}/ui/js/holder/holder.js"></script>
<script type="text/javascript" src="${BasePath}/ui/js/load-metro.js"></script>
